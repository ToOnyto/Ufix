...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Création du timer 
  var countDownDate = new Date("January 2, 2020 14:00:00").getTime();
  ...
  var x = setInterval(function () {
    ...
    document.getElementById("timer").innerHTML = "Le site UFix sera disponible dans : " + days + " jours, " + hours + " heures et " + minutes + " minutes !";
