 ...
 */
final class Version20191226151402 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE repair_proposition (id INT AUTO_INCREMENT NOT NULL, ad_id INT DEFAULT NULL, proposer_id INT DEFAULT NULL, price INT NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_12C9A8724F34D596 (ad_id), INDEX IDX_12C9A872B13FA634 (proposer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
