 ...
 */
final class Version20200108181324 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE repair_proposition (id INT AUTO_INCREMENT NOT NULL, ad_id INT DEFAULT NULL, proposer_id INT DEFAULT NULL, price INT NOT NULL, description LONGTEXT NOT NULL, current_state INT NOT NULL, INDEX IDX_12C9A8724F34D596 (ad_id), INDEX IDX_12C9A872B13FA634 (proposer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ad (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, repairer_id INT DEFAULT NULL, ad_type INT NOT NULL, product_name VARCHAR(255) NOT NULL, product_category INT NOT NULL, product_break_description VARCHAR(255) NOT NULL, product_price INT NOT NULL, ad_description LONGTEXT NOT NULL, current_state INT NOT NULL, repair_propositions LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_77E0ED587E3C61F9 (owner_id), INDEX IDX_77E0ED5847C5DFEE (repairer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, adress LONGTEXT NOT NULL, post_code INT NOT NULL, country VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, owned_ads LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', repaired_ads LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', repair_propositions LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
